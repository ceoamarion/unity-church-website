...
/**
 * Construction — Sticky scroll-driven section that builds the church.
...
export default function Construction() {
  ...
  return (
    <>
      ...
      <section ref={sectionRef} className="construction" id="construction">
        {/* This div gets pinned — it's the viewport for the animation */}
