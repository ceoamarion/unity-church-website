 ...
 * 
 * Receives normalized progress (0→1) and maps it to video.currentTime.
 * Uses requestAnimationFrame interpolation loop for smooth, jitter-free scrubbing.
 * 
 * The video is NOT autoplayed. Scroll position IS the playhead.
 * Scrolling forward advances the video. Scrolling backward reverses it.
 * 
 * @param {Object} props
